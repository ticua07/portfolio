...
import SkillsIntroduction from "../components/SkillsIntroduction";
            ...
            <div className={styles.cardImage}>
              <section className={styles.content}>
                ...
                <div className={styles.project__text}>
                  <p>
                    Web scraper with UI, for looking at products in Mercado
                    Libre
                  </p>
                  <p>Some of it&apos;s features are:</p>
                  <ul>
                    <li>
                      Products are saved and restored when closing and opening
                      the website.
                    </li>
